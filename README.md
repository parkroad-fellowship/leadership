...
A Flutter-based mobile application built with a clean, modular architecture. Supports iOS, Android and Web.
...
See [docs/mobile-architecture.md](docs/mobile-architecture.md) for full architecture and implementation notes.
