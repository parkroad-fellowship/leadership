...
class MissionTypeCard extends StatelessWidget {
  const MissionTypeCard({
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: missionType.isActive == PRFActiveStatus.active
                        ? Colors.green.withValues(alpha: 0.15)
                        : Colors.grey.withValues(alpha: 0.15),
                    borderRadius: BorderRadius.circular(PRFRadiusTokens.sm),
                  ),
                  child: Text(
                    missionType.isActive == PRFActiveStatus.active
                        ? 'Active'
                        : 'Inactive',
